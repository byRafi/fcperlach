          ...
          {fields.map(feld => (
            <div key={feld}>
              ...
              <div
                ...
                style={{ position: 'relative', width: '1001px', height: '741px', backgroundImage: 'url(https://upload.wikimedia.org/wikipedia/commons/4/45/Football_field.svg)', backgroundSize: '100% 100%', backgroundPosition: 'center', borderRadius: '1rem', padding: '1rem', margin: '0 auto' }}
              >
